...
class Innerloop_bg_TIF_IE_6pPol(Innerloop):
    """
    Information about Innerloop_bg_TIF_IE_6pPol:
    ...
    def score(self, A):
        ...
        for rule_num in range(self.Nr):
            ...
            for dataset_num in range(self.Nd):
                ...
                cl_str = self.auryn_sim_dir + "sim_innerloop_bg_TIF_IE_6pPol --ID " + str(id) +\
                    " --NE " + str(self.NE) +\
                    " --NI " + str(self.NI) +\
                    " --wee " + str(self.wee) +\
                    " --wei " + str(self.wei) +\
    ...
    def __str__(self):
        return("Above: parameters from Innerloop_ISPnet_pol_Auryn: " + str(print(vars(self))))
