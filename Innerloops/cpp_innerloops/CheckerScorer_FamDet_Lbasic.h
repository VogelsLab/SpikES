#ifndef CHECKERSCORER_FAMDET_LBASIC_H_
#define CHECKERSCORER_FAMDET_LBASIC_H_
 ...
 * It implements both a rate checker and computes online the loss for the FamDet_LBasicNet Innerloop in synapseek.
...
class CheckerScorer_FamDet_Lbasic : public Checker
{
private:
...
public:
	 ...
	 */
	CheckerScorer_FamDet_Lbasic(SpikingGroup* source, AurynFloat min, AurynFloat max, AurynFloat tau_pop, AurynFloat rate_cut_fam, AurynFloat rate_cut_new);
	virtual ~CheckerScorer_FamDet_Lbasic();
...
#endif /*CHECKERSCORER_FAMDET_LBASIC_H_*/